...
export default function OrgSettingsPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-foreground/5 px-8 pt-5 pb-0">
        <button
          onClick={() => navigate(-1)}
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">{settings.slug} &middot; {settings.member_count} membre{settings.member_count !== 1 ? "s" : ""} &middot; {settings.project_count} projet{settings.project_count !== 1 ? "s" : ""}</p>
          </div>
        </div>
